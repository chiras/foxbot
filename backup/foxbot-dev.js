...
var logfile = "logs/requests.log";
var setfile = "data/setfile.txt";
...
var setitems = require('./setfile.json');

//console.log(util.inspect(setitems, false, null));
