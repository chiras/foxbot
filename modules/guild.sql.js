...
module.exports = (bot, msg, mysql) => {
		...
		var queryG = "REPLACE INTO guilds (guildid, guildname, ownername, ownerid) VALUES ('"+msg.guild.id+"', '"+msg.guild.name.replace(/\'/g,"")+"', '"+msg.guild.owner.user.username.replace(/\'/g,"")+"','"+msg.guild.owner.user.id+"');"
		...
		channels.forEach(function(channel){				
				queryC += "REPLACE INTO guilds_channels (channelid, guildid, channelname, type) VALUES ('"+channel.id+"','"+msg.guild.id+"', '"+channel.name.replace(/\'/g,"")+"', '"+channel.type+"');"
		...
		members.forEach(function(member){				
				...
				queryM += "REPLACE INTO guilds_users (id, guild, userid, username, role) VALUES ('"+key+"','"+msg.guild.id+"', '"+member.user.id+"', '"+member.user.username.replace(/\'/g,"")+"','"+member.highestRole.id+"');"
		})
		...
		roles.forEach(function(role){
				...
				query2 += "REPLACE INTO guilds_roles (id, guild, roleid, rolename) VALUES ('"+key+"','"+msg.guild.id+"', '"+role.id+"', '"+role.name.replace(/\'/g,"")+"');"
